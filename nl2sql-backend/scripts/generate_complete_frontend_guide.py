...
def build_pdf(output_path: str):
    ...
    story.append(render_comp_card(
        ...
        "The primary onboarding interface rendered when no session is active. Features the official NL2SQL brand logo, quick-explore demo buttons (Hospital and E-Commerce), "
    ...
    features_data = [
        ...
        },
        {
            ...
            "desc": "Microphone voice query input using a ref-managed SpeechRecognition instance set to en-IN. Sets upfront expectations  and shows an inline safety-net chip ('Didn't catch that clearly? You can also type in Tamil or English') when speech is low-confidence or fragmented. English and Thanglish voice input work seamlessly, while typed Tamil script delivers 100% precision.",
