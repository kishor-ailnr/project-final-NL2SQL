                    ...
                    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                        ...
                        <motion.div
                            ...
                            className={cnFunction(
                                `relative z-[9999] w-full max-w-lg rounded-2xl border border-slate-200/90
                bg-white/95 backdrop-blur-xl p-6 shadow-2xl max-h-[90vh] overflow-y-auto text-slate-800`,
                                className
                            )}
                            role="dialog"
                            aria-modal="true"
                        ...
                        >
                            ...
                            {!hideCloseButton && (
                                <button
                                    onClick={() => setOpen(false)}
                                    className="absolute right-4 top-4 rounded-lg p-1 text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-teal-500 disabled:pointer-events-none"
...
const DialogDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
    ({ className, ...props }, ref) => (
        <p
            ref={ref}
            className={cnFunction("text-sm text-slate-500", className)}
            {...props}
        />
    )
);
